...
def calcAccuracy(loopCount:Int, train:Double, test:Double)={
  ...
  Console.println("\n*** NaiveBayes Average Results [" + loopCount + " runs | " + train + " / " + test + "]: " + (results.sum/loopCount))
  ...
  Console.println("\n*** Linear SVM Average Results [" + loopCount + " runs | " + train + " / " + test + "]: " + (svmResults.sum))
  ...
  Console.println("\n*** Decision Tree Average Results [" + loopCount + " runs | " + train + " / " + test + "]: " + (dtResults.sum / loopCount))
}
